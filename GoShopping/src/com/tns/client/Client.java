...
public class Client 
		{
			public static void main(String[] args) 
			{
				...
				gssfactory.getNewPrimeAccount(123, "Pratikriya", 1000, true);
				gssfactory.getNewNormalAccount(111, "Pratiksha", 1000, 50);
				...
				// Step 3
				GSNormalAcc gsnormal = new GSNormalAcc(0, null, 0, false); 
				gsnormal.getAccNm();
				gsnormal.getAccNo();
				gsnormal.getCharges();
